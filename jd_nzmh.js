/*
女装盲盒
活动地址：https://h5.m.jd.com/babelDiy/Zeus/2x36jyruNVDWxUiAiGAgHRrkqVX2/index.html
活动入口：京东app-女装馆-赢京豆
...
!(async () => {
  ...
  for (let i = 0; i < cookiesArr.length; i++) {
    if (cookiesArr[i]) {
      ...
      try {
        await jdMh('https://anmp.jd.com/babelDiy/Zeus/2x36jyruNVDWxUiAiGAgHRrkqVX2/index.html') // 10.1-10.31
      } catch (e) {
        $.logErr(e)
      }
    }
