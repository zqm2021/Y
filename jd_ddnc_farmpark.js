...
cron 37 10 * * * jd_ddnc_farmpark.js

============Quantumultx===============
[task_local]
#东东乐园
37 10 * * * jd_ddnc_farmpark.js, tag=东东乐园, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "37 10 * * *" script-path=jd_ddnc_farmpark.js tag=东东乐园

===============Surge=================
东东乐园 = type=cron,cronexp="37 10 * * *",wake-system=1,timeout=3600,script-path=jd_ddnc_farmpark.js

============小火箭=========
东东乐园 = type=cron,script-path=jd_ddnc_farmpark.js, cronexpr="37 10 * * *", timeout=3600, enable=true
