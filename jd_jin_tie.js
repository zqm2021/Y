...
[task_local]
#领金贴
10 0,10 * * * jd_jin_tie.js, tag=领金贴, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
===========Loon===============
[Script]
cron "10 0,10 * * *" script-path=https://jdsharedresourcescdn.azureedge.net/jdresource/jd_jin_tie.js,tag=领金贴
=======Surge===========
领金贴 = type=cron,cronexp="10 0,10 * * *",wake-system=1,timeout=3600,script-path=https://jdsharedresourcescdn.azureedge.net/jdresource/jd_jin_tie.js
==============小火箭=============
领金贴 = type=cron,script-path=https://jdsharedresourcescdn.azureedge.net/jdresource/jd_jin_tie.js, cronexpr="10 0,10 * * *", timeout=3600, enable=true
 */
const $ = new Env('领金贴');
...
let shareId = ["e506cfec2cff4704b63077066f224038", "58dec205098349d2a4c58f4de53c5266", "8071b0c771ea432fb8ec41d0e175b996"][Math.floor((Math.random() * 3))];
if ($.isNode()) {
