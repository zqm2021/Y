...
cron 18 10 * * * jd_wyw.js

============Quantumultx===============
[task_local]
#玩一玩成就
18 10 * * * jd_wyw.js, tag=玩一玩成就, img-url=https://raw.githubusercontent.com/tsukasa007/icon/master/jd_wyw.png, enabled=true

================Loon==============
[Script]
cron "18 10 * * *" script-path=jd_wyw.js,tag=玩一玩成就

===============Surge=================
玩一玩成就 = type=cron,cronexp="18 10 * * *",wake-system=1,timeout=3600,script-path=jd_wyw.js

============小火箭=========
玩一玩成就 = type=cron,script-path=jd_wyw.js, cronexpr="18 10 * * *", timeout=3600, enable=true
*/
const $ = new Env('玩一玩成就');
